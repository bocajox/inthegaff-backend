...
module.exports = {
  id: 'nicholashumphreys', name: 'Nicholas Humphreys', website: BASE,
  ...
  async scrape() {
    ...
    while (true) {
      ...
      const cards = $('[class*="property"], .property-item, article.listing').toArray();
      ...
      if (!$('a[rel="next"]').length || page >= 10) break;
